...
\DeclareCaptionLabelSeparator{dash}{ -- } % добавление разделителя тире
...
\captionsetup[table]{labelsep=dash}           % установка разделителя
...
\captionsetup[lstlisting]{labelsep=dash} % установка разделителя
...
% Настройка параметров его отображения
