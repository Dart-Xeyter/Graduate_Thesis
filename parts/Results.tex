...
\begin{table}[h]
	...
	\begin{minipage}{0.48\textwidth}
		\caption{Хэмминг, Утв.~\ref{st:Ham}~и~\ref{st:search}}
		\centering
		\begin{tabular}{|c|c|c|}
			\hline Q & t & err \\ \hline
			2 & 21 & 0.0058 \\ \hline
	...
	\end{minipage}
	\begin{minipage}{0.48\textwidth}
		\caption{Ли, Утв.~\ref{st:Li}~и~\ref{st:search}}
		\centering
...
Последние столбцы отвечают за вероятность ошибки в каждом символе (если рассматривать их независимо). В метрике Ли это вероятности отличия от исходного символа на расстояние $1$ и $2$ соответственно.

Для $\NewHope$ делаем то же самое, только рассматривая другие $Q$:

\begin{table}[h]
	\caption{Хэмминг, Ли, Утв.~\ref{st:Ham},\ref{st:Li}~и~\ref{st:search}}
	\centering
	\begin{tabular}{|c|c|c|}
		\hline Q & t & err \\ \hline
		2 & 0 & $\approx 0$ \\ \hline
...
Тем не менее, при больших значениях $Q$ разница проявляется. Дальше по известным $n$ и $d$ считаются границы на битовую скорость $R$.

\begin{table}[h]
	\centering
	\begin{minipage}{0.48\textwidth}
		\caption{LAC, Хэмминг, Утв.~\ref{st:bounds}}
		\centering
		\label{tab:LAC,Ham}
		\begin{tabular}{|c|c|c|}
	...
	\hfill
	\begin{minipage}{0.48\textwidth}
		\caption{LAC, Ли, Утв.~\ref{st:bounds}}
		\centering
		\label{tab:LAC,Li}
		\begin{tabular}{|c|c|c|}
			\hline Q & $R_{GV}$ & $R_H$ \\ \hline
...
\begin{table}[h]
	\centering
	\begin{minipage}{0.48\textwidth}
		\caption{NewHope, Хэмминг, Утв.~\ref{st:bounds}}
		\centering
		\label{tab:Hope,Ham}
		\begin{tabular}{|c|c|c|}
			\hline Q & $R_{GV}$ & $R_H$ \\ \hline
	...
	\hfill
	\begin{minipage}{0.48\textwidth}
		\caption{NewHope, Ли, Утв.~\ref{st:bounds}}
		\centering
		\label{tab:Hope,Li}
		\begin{tabular}{|c|c|c|}
			\hline Q & $R_{GV}$ & $R_H$ \\ \hline
...
Также занимательно, что вероятность возникновения отличия на $\geq\!2$ в метрике Ли перестаёт быть пренебрежимо мала лишь к моменту, когда вероятность отличия на $1$ становится огромна (порядка $\frac14$ и выше).
